...
facetmark is a project about measurement, and most of what it publishes is
negative results. Disagreement about *numbers* is welcome and expected —
challenge a protocol, a criterion, a query set, or a conclusion as hard as you
like. Disagreement about numbers is not a licence to be unpleasant about people.
"This measurement does not support that claim" is on topic. "You are incompetent
for publishing it" is not.
...
private vulnerability reporting, or by the contact route described in
...
warning, with clarity about the nature of the violation and an explanation of
